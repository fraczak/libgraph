...
for {topo,args} in [{topo:"cycle",args:[60]}, {topo:"lattice",args:[14,8]}]
...
for {topo,args} in [{topo:"cgrid", args:[4,3]}, {topo:"ring", args:[10]}, {topo:"cycle", args:[10]}, {topo:"lattice",args:[5,3]}]
